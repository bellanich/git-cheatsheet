...
\begin{tikzpicture}
	\node [mybox, fill=boxcolor, draw=outlinecolor] (box){%
		...
		\underline{Where is remote stored?}: The remote repo lives on a \textcolor{outlinecolor}{version control hosting services} and is accessible via a web-based interface. 
		\begin{itemize}
			\item \textit{Examples.} Popular Git repository hosting services include \href{https://github.com}{GitHub}, \href{https://about.gitlab.com}{GitLab}, and \href{https://bitbucket.org/product}{BitBucket}. See \href{https://gitprotect.io/blog/top-git-hosting-services-for-2022/}{here} for more info.
			\item \textit{Open-source standard.} \href{https://github.com}{GitHub} is considered the standard for hosting open-source projects due to its immense popularity. 
		\end{itemize}
		
		Remote hosting services \textcolor{outlinecolor}{offer unique functionalities} that are \textcolor{outlinecolor}{separate from Git}, including: \href{https://docs.github.com/en/get-started/learning-about-github/access-permissions-on-github}{access control},  \href{https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests}{pull requests}, \href{https://docs.github.com/en/issues/tracking-your-work-with-issues/about-issues}{issue tracking}, and automation tools like \href{https://github.com/features/actions}{GitHub Actions}. \\
