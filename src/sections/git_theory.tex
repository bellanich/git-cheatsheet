...
\begin{tikzpicture}
	\node [mybox, fill=boxcolor, draw=outlinecolor] (box){%
		\begin{minipage}{0.3\textwidth}
			...
			\underline{Where is remote stored?}: The remote repo lives on a \textcolor{outlinecolor}{version control hosting services}, which provides a web-based management interface. 
			\begin{itemize}
				...
				\item \textit{Open-source standard.} \href{https://github.com}{GitHub} is the most popular one and is considered the standard for hosting open-source projects. 
			\end{itemize}
			\textit{Different from Git.}
