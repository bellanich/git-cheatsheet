...
\begin{tikzpicture}
	\node [mybox, fill=boxcolor, draw=outlinecolor] (box){%
		\begin{minipage}{0.3\textwidth}
			...
			A project's Git history is typically \textcolor{outlinecolor}{represented as a directed acyclic graph (DAG)} data structure. Use the idea of a  \href{https://simonwillison.net/2022/Oct/29/the-perfect-commit/}{perfect commit} to scope your commits.
			\vspace{2mm}
			...
			\underline{Compare}: You can compare \textbf{(a)} what you have and haven't committed in Git as well as \textbf{(b)} different points in your commit history.
			\vspace{-4mm}
			\begin{center}
				\textcolor{background}{
					\begin{tabularx}{\textwidth}{>{\columncolor{rowcolor1}}X|>{\columncolor{rowcolor2}}p{4cm}}
			...
			\underline{Repo restructuring} can be easily tracked in Git.
