	...
	\node [mybox, fill=boxcolor, draw=outlinecolor] (box){%
		\begin{minipage}{0.3\textwidth}
			...
			\begin{minipage}{0.45\textwidth}
				...
				\captionsetup{justification=centering}
				\captionof{figure}{After a 3-way merge \href{https://www.atlassian.com/git/tutorials/using-branches/git-merge}{ \faLink{}  Source}}
			\end{minipage}
			% End figure
			\vspace{-3mm}
	...
	\node [mybox, fill=boxcolor, draw=outlinecolor] (box){%
		\begin{minipage}{0.3\textwidth}
			...
			\begin{enumerate}
				...
				\item \href{https://martinfowler.com/articles/ship-show-ask.html}{Ship / Show / Ask} has 3 categories for merges: (continued)
			\end{enumerate}
			\vspace{-3mm}
			\begin{center}
				\textcolor{background}{
